...
""")
	...
	def write_preamble (self):
		...
		self.write_newline ()
		self._file_.write ('THIS_DIR=$(cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd)\n')
	...
	def append_libpath_variable (self, value):
		if sys.platform == 'darwin':
			self.append_env_variable ('DYLD_LIBRARY_PATH', os.path.normpath (value))
		else:
			self.append_env_variable ('LD_LIBRARY_PATH', os.path.normpath (value))
